...
/**
 * DTO para receber dados de Especialidade da API Spring Boot
...
public class EspecialidadeDTO {
    ...
    // Campo extra que existe na API mas não no modelo de domínio
    ...
    // Lista de pacientes (relacionamento)
    ...
    public List<PacienteEspecialidadeDTO> getPacientes() {
        return pacientes;
    }
    
    public void setPacientes(List<PacienteEspecialidadeDTO> pacientes) {
